...
class Marksheet_model extends Model
{
	protected $db;
	...
	function getDetailsToApply($enrollNo = 0, $branchId = 0){
		$this->adm->select('admission.*, pay.course_fees, pay.discount, pay.amount, mfm.subjects, mfm.marks, mfm.labels, course.short_name, course.course_name as courseName, course.total_marks as totalMarks, branch.branch_name,course.typing_test');
