                ...
                <div class="container">
                    <div class="row justify-content-center branch-login">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                            <form method="POST" action="<?= site_url('branch/forgot-password'); ?>" onsubmit="submitButton.disabled = true; return true;" accept-charset="UTF-8">
                                    ...
                                    <div class="crs_log__caption">
                                        ...
                                        <div class="rcs_log_124 pb-5">
                                            ...
                                            <div class="form-grouppb-2">
                                                <?= csrf_field(); ?>
                                                <button name="submitButton" type="submit" class="btn full-width btn-sm theme-bg text-white">RESET PASSWORD</button>
                                            </div>
                                            <?= view('Auth\Views\_notifications') ?>
                                        </div>
                                    </div>
                                    <div class="crs_log__footer d-flex justify-content-between">
                                        <div class="fhg_45"><p class="musrt">Already have an account? <a href="/branch" class="theme-cl">Login</a></p></div>
                                    </div>
                                </div>
                            </form>
                        </div>
