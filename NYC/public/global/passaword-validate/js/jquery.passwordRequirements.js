    ...
    $.fn.extend({
        passwordRequirements: function(options) {
            ...
            return this.each(function() {
				...
				var numCharactersUI = '<li class="pr-numCharacters"><span></span>' + o.numCharacters + ' of characters</li>',
					useLowercaseUI = '',
					useUppercaseUI = '',
					useNumbersUI   = '',
					useSpecialUI   = '';
				...
				var messageDiv = '<div id="pr-box" class="pr-box"><i></i><div id="pr-box-inner"><p>' + o.infoMessage + '</p><ul>' + numCharactersUI + useLowercaseUI + useUppercaseUI + useNumbersUI + useSpecialUI + '</ul></div></div>';
