					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-content collapse show">
								<div class="card-body">
									<table id="dt-type-of-exam" class="table table-white-space table-bordered table-striped row-grouping display no-wrap icheck table-middle dataTable no-footer">
										<thead>
											<tr>
												<th width="7%">#</th>
												<th width="71%">EXAM TYPE</th>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="master-type-of-degree-label"> Save Exam Type</h3>
			</div>
			<form action="<?= site_url('master/save-type-of-exam') ?>" id="form-type-of-exam">
				<div class="modal-body">
					<div class="form-group floating-label-form-group">
						<label for="exam-type" class="form-label">Exam Type <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="exam-type" name="exam-type" placeholder="Enter exam type...">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary" id="btn-type-of-exam">Save</button>
				</div>
			</form>
		</div>
	</div>
...
<?= $this->endSection() ?>
<?= $this->section('js') ?>
<?= script_tag(ADMIN_ASSETS.'js/pages/master/type-of-exam.init.js?v='.filemtime('assets/js/pages/master/type-of-exam.init.js')) ?>
<?= $this->endSection() ?>
<?= $this->endSection() ?>