					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-content collapse show">
								<div class="card-body">
									<table id="dt-type-of-degree" class="table table-white-space table-bordered table-striped row-grouping display no-wrap icheck table-middle dataTable no-footer">
										<thead>
											<tr>
												<th width="7%">ID</th>
												<th width="71%">TYPE</th>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="master-type-of-degree-label"> Save Degree of Type</h3>
			</div>
			<form action="<?= site_url('master/save-type-of-degree') ?>" id="form-type-of-degree">
				<div class="modal-body">
					<div class="form-group floating-label-form-group">
						<label for="degree_type" class="form-label">Degree Type <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="degree_type" name="degree_type" placeholder="Enter degree type name...">
...
<?= $this->endSection() ?>
<?= $this->section('js') ?>
<?= script_tag(ADMIN_ASSETS.'js/pages/master/type-of-degree.init.js?v='.filemtime('assets/js/pages/master/type-of-degree.init.js')) ?>
<?= $this->endSection() ?>
<?= $this->endSection() ?>