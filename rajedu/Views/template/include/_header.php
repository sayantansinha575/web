...
<head>
    ...
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/charts/chartist.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/charts/chartist-plugin-tooltip.css">
    <!-- END: Vendor CSS-->
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/tables/datatable/datatables.min.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/editors/tinymce/tinymce.min.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/forms/selects/select2.min.css">
    ...
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>css/core/colors/palette-gradient.min.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>css/pages/chat-application.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>css/pages/dashboard-analytics.min.css">


    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>css/style.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/swall.min.css">

    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/forms/icheck/icheck.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/forms/icheck/custom.css">
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>vendors/css/timeline/vertical-timeline.css">
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse show" id="navbar-mobile">
                  ...
                  <li class="col-md-3">
                    ...
                    <div class="carousel slide pt-1" id="carousel-example" data-ride="carousel">
                      <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active"><img class="d-block w-100" src="<?= ADMIN_ASSETS ?>images/carousel/08.jpg" alt="First slide"></div>
                        <div class="carousel-item"><img class="d-block w-100" src="<?= ADMIN_ASSETS ?>images/carousel/03.jpg" alt="Second slide"></div>
                        <div class="carousel-item"><img class="d-block w-100" src="<?= ADMIN_ASSETS ?>images/carousel/01.jpg" alt="Third slide"></div>
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail">             </i></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  <div class="arrow_box_right">
                    ...
                    <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                        <div class="media">
                          <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="<?= ADMIN_ASSETS ?>images/portrait/small/avatar-s-6.png" alt="avatar"></span></div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="<?= ADMIN_ASSETS ?>images/portrait/small/avatar-s-3.png" alt="avatar"></span></div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="<?= ADMIN_ASSETS ?>images/portrait/small/avatar-s-19.png" alt="avatar"></span></div>
                          <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="<?= ADMIN_ASSETS ?>images/portrait/small/avatar-s-19.png" alt="avatar"></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="<?= ADMIN_ASSETS ?>images/portrait/small/avatar-s-19.png" alt="avatar"><span class="user-name text-bold-700 ml-1">John Doe</span></span></a>
