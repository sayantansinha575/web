...
var AuthGroupsNPermissions = function() {
    // Elements
    ...
    var handleIntakeListDT = function (e) {
        datatable = $(table).DataTable({
            ...
            'ajax': {
                url: site_url+'auth/get-groups-n-permissions-dt',
                data: function(data){
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'auth/delete-groups-n-permissions',
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'auth/change-groups-n-permissions-status',
    ...
    return {
        // Initialization
        init: function() {
            form = $('#form-groups-n-permissions');
            submitButton = $('#btn-groups-n-permissions');
            btnHtml = submitButton.html();
            csrf = $('[name=x_token]');
            table = document.querySelector('#dt-groups-n-permissions');
            modalEl = document.querySelector('#modal-groups-n-permissions');
            if (table) {
                handleIntakeListDT();
            }
