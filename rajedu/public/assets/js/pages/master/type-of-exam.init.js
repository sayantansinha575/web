...
var masterTypeOfDegree = function() {
    ...
    var handleTypeOfDegreeListDT = function (e) {
        datatable = $(table).DataTable({
            ...
            'ajax': {
                url: site_url+'master/get-type-of-exam-dt',
                data: function(data){
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/delete-type-of-exam',
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/change-type-of-exam-status',
    ...
    return {
        // Initialization
        init: function() {
            form = $('#form-type-of-exam');
            submitButton = $('#btn-type-of-exam');
            btnHtml = submitButton.html();
            csrf = $('[name=x_token]');
            table = document.querySelector('#dt-type-of-exam');
