...
var masterTypeOfDegree = function() {
    ...
    var handleTypeOfDegreeListDT = function (e) {
        datatable = $(table).DataTable({
            ...
            'ajax': {
                url: site_url+'master/get-test-type-dt',
                data: function(data){
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/delete-test-type',
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/change-test-type-status',
    ...
    return {
        // Initialization
        init: function() {
            form = $('#form-type-of-test');
            submitButton = $('#btn-type-of-test');
            btnHtml = submitButton.html();
            csrf = $('[name=x_token]');
            table = document.querySelector('#dt-type-of-test');
