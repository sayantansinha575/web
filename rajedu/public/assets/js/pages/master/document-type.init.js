...
var masterTypeOfDegree = function() {
    ...
    var handleTypeOfDegreeListDT = function (e) {
        datatable = $(table).DataTable({
            ...
            'ajax': {
                url: site_url+'master/get-document-type-dt',
                data: function(data){
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/delete-document-type',
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/change-document-type-status',
    ...
    return {
        // Initialization
        init: function() {
            form = $('#form-type-of-document');
            submitButton = $('#btn-type-of-document');
            btnHtml = submitButton.html();
            csrf = $('[name=x_token]');
            table = document.querySelector('#dt-type-of-document');
