...
var masterTypeOfDegree = function() {
    // Elements
    ...
    var handleTypeOfDegreeListDT = function (e) {
        datatable = $(table).DataTable({
            ...
            'ajax': {
                url: site_url+'master/get-type-of-degree-dt',
                data: function(data){
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/delete-type-of-degree',
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/change-type-of-degree-status',
    ...
    return {
        // Initialization
        init: function() {
            form = $('#form-type-of-degree');
            submitButton = $('#btn-type-of-degree');
            btnHtml = submitButton.html();
            csrf = $('[name=x_token]');
            table = document.querySelector('#dt-type-of-degree');
            modalEl = document.querySelector('#modal-master-type-of-degree');
            if (table) {
