...
var masterTypeOfDegree = function() {
    ...
    var handleStatusListDT = function (e) {
        datatable = $(table).DataTable({
            ...
            'ajax': {
                url: site_url+'master/get-status-dt',
                data: function(data){
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/delete-status',
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: site_url + 'master/change-status-status',
    ...
    return {
        ...
        init: function() {
            form = $('#form-status');
            submitButton = $('#btn-status');
            btnHtml = submitButton.html();
            csrf = $('[name=x_token]');
            table = document.querySelector('#dt-status');
            modalEl = document.querySelector('#modal-master-status');
            if (table) {
                handleStatusListDT();
            }
