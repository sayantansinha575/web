                                ...
                                <?php foreach ($examList as $record): ?>        
                                    <tr>
                                        ...
                                        <td><?php if ($record->status == 1): ?>
                                                <a href="javascript:void(0)" data-toggle="tooltip" title="Click to inactive" class="changePaperStatus" data-course="<?=$course_id;?>" data-id="<?= $record->id ?>" data-val="2"><span class="badge badge-success-lighten">Active</span></a>
                                            <?php else: ?>
                                                <a href="javascript:void(0)" data-toggle="tooltip" title="Click to Active" class="changePaperStatus" data-course="<?=$course_id;?>"  data-id="<?= $record->id ?>" data-val="1"><span class="badge badge-danger-lighten">Inactive</span></a>
                                            <?php endif ?></td>
